...
public class GameMap extends JPanel {
    ...
    private final String MSG_HUMAN = "Вы выиграли";
    private final String MSG_AI = "Вы проиграли";
    ...
    private void update(MouseEvent mouseObject) {
        ...
        mainWindow.putLogs("Игрок [" + (cellX +1) + ":" + (cellY + 1) + "]");
    ...
    private void showGameOverMessage(int stateGameOver) {
        switch (stateGameOver) {
            case STATE_WIN_HUMAN:
                JOptionPane.showMessageDialog(this, MSG_HUMAN);
                mainWindow.putLogs(MSG_HUMAN);
                break;
            case STATE_WIN_AI:
                JOptionPane.showMessageDialog(this, MSG_AI);
                mainWindow.putLogs(MSG_AI);
                break;
            case STATE_DRAW:
                JOptionPane.showMessageDialog(this, MSG_DRAW);
                mainWindow.putLogs(MSG_DRAW);
                break;
        }
    }
    ...
    private void  createMap (Graphics g) {
        ...
        cellWight = wigth / mapSizeX;
        cellHeight = height / mapSizeY;
        g.setColor(Color.BLACK);

        for (int i = 0; i <= mapSizeY; i++) {
            int y = i * cellHeight;
            g.drawLine(0, y, wigth, y);
        }
